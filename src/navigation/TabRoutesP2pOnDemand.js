        ...
        options={({ route, navigation }) => ({
          ...
          tabBarIcon: ({ focused, tintColor }) => (
            <Image
              ...
              source={focused ? imagePath.fillHome : imagePath.vectorHome}
            />
          ),
        })}
      />
       <Tab.Screen
        ...
        name={navigationStrings.CAR_RENTAL_STACK}
        options={({ route, navigation }) => ({
        //   tabBarVisible: getTabBarVisibility(route, navigation, [
        ...
        //   ]),
          ...
          tabBarIcon: ({ focused, tintColor }) => (
            <Image
              ...
              source={focused ? imagePath.fillSearch : imagePath.vectorSearch}
            />
          ),
        })}
      />
            ...
            <View style={{}}>
              {/* <Image
                style={{
                  ...
                  height: 60,
                  width: 60,
                  tintColor: themeColors?.secondary_color_new,
                }}
              ...
              <View
                style={{
                  ...
                  top: -35,
                  left: -30,
                  backgroundColor: themeColors?.secondary_color_new,
                  borderColor: themeColors?.secondary_color_new,
              ...
              >
                <Image
                 ...
                 style={{
                    height: 30,
                    width: 30,
                    tintColor: themeColors?.secondary_color,
                 }}
                />
              </View>
            </View>
        ...
        options={({ route, navigation }) => ({
          ...
          tabBarIcon: ({ focused, tintColor }) => (
            ...
            //   source={focused ? imagePath.icChatActive : imagePath.ic_chat}
              source={focused ? imagePath.fillCar : imagePath.vectorCar}
        ...
        options={({ route }) => ({
          ...
          tabBarIcon: ({ focused, tintColor }) => (
            <Image
              ...
              source={focused ? imagePath.fillProfile : imagePath.vectorProfile}
            />
          ),
        })}
      />
