                ...
                <Animated.View
                  ...
                  <View
                    style={{
                      ...
                      width: showCheckBox ? moderateScale(345) : width / 1.05,
                      alignItems: 'center',
                    ...
                    <View style={{ ...styles.cartItemDetailsCon, flex: 1 }}>
                      <View
                        style={{
                          flexDirection: 'row',
                        ...
                        <View style={{ flex: 1 }}>
                          ...
                          {!!i?.schedule_slot ? (
                            <Text
                              ...
                              {' '}
                              {i?.scheduled_date_time} {i?.schedule_slot}
                            </Text>
                          ) : null}
