...
export default function ProductWithCategoryOD({route, navigation}) {
            ...
            <View style={styles.horizontalView}>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <View
                  ...
                  <Text>
                    {' '}
                    {Number(categoryInfo?.product_avg_average_rating || categoryInfo?.rating).toFixed(
                      1,
                    )}
                  </Text>
                </View>
